...
ALTER TABLE "user_course_traces" ADD FOREIGN KEY ("user_uid") REFERENCES "users" ("user_uid");
...
VALUES 
	...
	('6602fd06a8fc89e974fa4561', '6602fd06a8fc89e974fa4560', '', 'python', 'Learn how the find the biggest or smallest values.', 8, false, 'Comparing Numbers', 'course', 1),
	('6602fd06a8fc89e974fa460f', '6602fd06a8fc89e974fa4560', '', 'python', 'Learn how to check if two strings are the same.', 9, false, 'Comparing Strings', 'course', 1),
	('6602fd06a8fc89e974fa46b2', '6602fd06a8fc89e974fa4560', '', 'python', 'Learn about the different types of values we can store in variables.', 10,false, 'Discovering Types', 'course', 1),
	('6602fd06a8fc89e974fa4795', '6602fd06a8fc89e974fa4560', '', 'python', 'Types and Comparisons', 11, false, 'Types and Comparisons', 'practiceRequired', 1),  ('6602fd06a8fc89e974fa4819', '6602fd06a8fc89e974fa4560', '', 'python', 'Types and Comparisons', 12, false,' Types and Comparisons', 'practiceOptional', 1),
  ('6602fd06a8fc89e974fa48de', '6602fd06a8fc89e974fa4560', '', 'python', 'Challenge Exercises\nbased on Types and Comparisons', 13, false, 'More Types and Comparisons', 'challenges', 1),
  ...
  ('6602fd63666d4ea08804109d', '6602fd63666d4ea08804109c', '', 'javascript', 'Learn how the find the biggest or smallest values.', 7, false, 'Comparing Numbers', 'course', 1),
  ('6602fd63666d4ea08804114b', '6602fd63666d4ea08804109c', '', 'javascript', 'Learn how to check if two strings are the same.', 8, false, 'Comparing Strings', 'course', 1),
  ('6602fd63666d4ea0880411ea', '6602fd63666d4ea08804109c', '', 'javascript', 'Learn about the different types of values we can store in variables.', 9, false, 'Discovering Types', 'course', 1),
  ('6602fd63666d4ea0880412c5', '6602fd63666d4ea08804109c', '', 'javascript', 'Learn about logical operators and how we can use them to connect more than one conditions.', 10, false, 'Logical Operator', 'course', 1),
  ('6602fd63666d4ea08804138b', '6602fd63666d4ea08804109c', '', 'javascript', 'Types and Comparisons', 11, false, 'Types and Comparisons', 'course', 1),
  ('6602fd63666d4ea088041424', '6602fd63666d4ea08804109c', '', 'javascript', 'Types and Comparisons', 12, false, 'Types and Comparisons', 'practiceOptional', 1),
  ('6602fd63666d4ea088041443', '6602fd63666d4ea08804109c', '', 'javascript', 'Mimo Challenges are more difficult code-based brain teasers that''ll improve your coding skills and sharpen your problem-solving abilities.', 13, false, 'Types and Comparisons', 'challenges', 1);
