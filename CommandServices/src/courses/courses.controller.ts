...
import { CreateCourseCommand, UpdateCourseCommand } from './commands/course.command';
...
export class CoursesController {
	...
	async updateCourse(updateCourseDto: UpdateCourseDto): Promise<Courses> {
		...
		return await this.commandbus.execute(new UpdateCourseCommand(updateCourseDto));
	}
